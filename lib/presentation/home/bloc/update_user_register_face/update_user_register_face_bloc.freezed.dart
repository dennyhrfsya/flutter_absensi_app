...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is UpdateUserRegisterFaceEvent);
}
...
$UpdateUserRegisterFaceEventCopyWith(UpdateUserRegisterFaceEvent _, $Res Function(UpdateUserRegisterFaceEvent) __);
}
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( _Started value)?  started,TResult Function( _UpdateProfileRegisterFace value)?  updateProfileRegisterFace,required TResult orElse(),}){
final _that = this;
switch (_that) {
case _Started() when started != null:
return started(_that);case _UpdateProfileRegisterFace() when updateProfileRegisterFace != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( _Started value)  started,required TResult Function( _UpdateProfileRegisterFace value)  updateProfileRegisterFace,}){
final _that = this;
switch (_that) {
case _Started():
return started(_that);case _UpdateProfileRegisterFace():
return updateProfileRegisterFace(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( _Started value)?  started,TResult? Function( _UpdateProfileRegisterFace value)?  updateProfileRegisterFace,}){
final _that = this;
switch (_that) {
case _Started() when started != null:
return started(_that);case _UpdateProfileRegisterFace() when updateProfileRegisterFace != null:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  started,TResult Function( String embedding,  XFile? image)?  updateProfileRegisterFace,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Started() when started != null:
return started();case _UpdateProfileRegisterFace() when updateProfileRegisterFace != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  started,required TResult Function( String embedding,  XFile? image)  updateProfileRegisterFace,}) {final _that = this;
switch (_that) {
case _Started():
return started();case _UpdateProfileRegisterFace():
return updateProfileRegisterFace(_that.embedding,_that.image);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  started,TResult? Function( String embedding,  XFile? image)?  updateProfileRegisterFace,}) {final _that = this;
switch (_that) {
case _Started() when started != null:
return started();case _UpdateProfileRegisterFace() when updateProfileRegisterFace != null:
return updateProfileRegisterFace(_that.embedding,_that.image);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  initial,TResult Function()?  loading,TResult Function( String message)?  error,TResult Function( UserResponseModel user)?  success,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  initial,required TResult Function()  loading,required TResult Function( String message)  error,required TResult Function( UserResponseModel user)  success,}) {final _that = this;
switch (_that) {
case _Initial():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  initial,TResult? Function()?  loading,TResult? Function( String message)?  error,TResult? Function( UserResponseModel user)?  success,}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
return initial();case _Loading() when loading != null:
return loading();case _Error() when error != null:
